...
public class CardGameFramework
{
   ...
   private static int numPacks;            // # standard 52-card packs per deck
   ...
   private static Hand[] hand;             // one Hand for each player
         ...
         int numPlayers, int numCardsPerHand)
   {
      ...
      newGame();
      //Fills each player's hand with Cards
      deal();
      //Loads card icons
   ...
   public static Hand getHand(int k)
   {
